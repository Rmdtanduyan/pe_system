# Generated by Django 4.2.9 on 2024-02-06 04:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('Department Chair', 'Department Chair'), ('Admin Associate', 'Admin Associate'), ('Full-Time Faculty', 'Full-Time Faculty'), ('Part-Time Faculty', 'Part-Time Faculty')], max_length=300)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(related_name='pe_choices', to=settings.AUTH_USER_MODEL)),
